...
//       aria-labelledby="faq-section-title" // Accessibility: Label the section
//     >
...
//                 aria-expanded={openIndex === index} // Accessibility: Indicate if the answer is expanded
//                 aria-controls={`faq-answer-${index}`} // Accessibility: Associate button with answer
//               >
