...
//   return (
//     <div
//       className="bg-gray-950 text-white px-8 pb-8 min-h-screen flex flex-col items-center pt-4 bg-gradient-to-br from-green-400/20 via-blue-500/20 to-green-400/10 backdrop-blur-xl"
