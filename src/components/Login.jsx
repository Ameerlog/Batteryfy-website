...
//             console.log(
//               "User already signed in with Google and phone number found. Navigating..."
//             );
//             navigate("/bank-system");
//           } else {
//             console.log(
//               "User signed in with Google, but phone number missing. Prompting for phone."
//             );
//             setShowPhoneNumberInput(true);
//           }
//         } catch (err) {
//           console.error("Error checking user document for phone number:", err);
//           setError("Failed to verify user data. Please try again or sign out.");
//         } finally {
//           setIsLoading(false);
//         }
//       } else {
//         console.log("No user signed in. Showing Google Sign-In.");
...
//         setError("Google sign-in request cancelled or already in progress.");
...
//     if (!currentUser) {
//       setError("No user signed in. Please sign in with Google first.");
//       setIsLoading(false);
//       return;
//     }
...
//           </form>
//         ) : (
//           // Display Google Sign-In button initially
//           <div className="mb-8">
//             <button
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast.success(
        ...
        { toastId: "google-sign-in-success" }
      );
    } catch (err) {
      console.error("Error during Google sign-in:", err);
