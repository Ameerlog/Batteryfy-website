...
//               className="absolute top-4 right-4 hover:text-red-200"
//             >
...
//               disabled={location}
//               className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 px-4 rounded-lg flex items-center justify-center gap-2 mb-5 shadow-md hover:shadow-lg disabled:opacity-70"
//             >
//               <FaMapMarkerAlt />
...
//                     className="w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"
//                   />
...
//                     className="w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 appearance-none"
//                   >
...
//                 }
//                 className={`w-full py-4 px-6 rounded-lg flex items-center justify-center gap-2 text-lg font-bold shadow-md transition-all duration-300 ${
//                   !location || !name.trim() || !mobile.trim() || !serviceType
