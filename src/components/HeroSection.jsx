...
// //       aria-labelledby="hero-title" // Accessibility: Label the section
// //     >
...
// import image3 from "../assets/Tricycle.png";
// import image4 from "../assets/cars.png";
// import image5 from "../assets/truck.png";
// import image6 from "../assets/heavy-duty.png";
...
//             <div
//               key={index}
//               className="bg-gray-900 rounded-xl overflow-hidden border border-blue-400  transition-all duration-300 hover:shadow-lg hover:scale-[1.02] aspect-square"
//             >
{
  /* <div className="flex justify-center items-center">
                <img
                  src={card.imageUrl}
                  alt={card.title}
                  className="w-full h-auto  rounded-t-xl aspect-square" */
}
{
  /* loading="lazy"
                 /> */
...
{
  /* <div className="flex justify-center gap-6 w-full absolute">
                  <Link
                    to="/battery-conversion"
                    aria-label={`Learn more about battery conversion for ${card.title}`}
                  >
...
// import image2 from "../assets/scooter.png";
// import image4 from "../assets/cars.png";
// import image2 from "../assets/s4.png";
// import image4 from "../assets/c1.png";
// import image3 from "../assets/Tricycle.png";
// import image5 from "../assets/truck.png";
// import image6 from "../assets/heavy-duty.png";
